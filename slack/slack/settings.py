...
SECRET_KEY = '$u8chwiw)6sd6ubygyz28+)%dw)sbnla_3!5$n*0_0jl-lrcg-'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['65205952.ngrok.io','127.0.0.1','localhost']
...
SLACK_BOT_USER_TOKEN = 'xoxb-575022529617-583483575811-l1H5cBphP0iQtpxDk8dfkoGL'
